...
assert.strictEqual(
  installPackage("github:maoshuhua/pavo-cli#v0.1.1"),
  "github:maoshuhua/pavo-cli#v0.1.1",
);
...
for (const pkg of [
  "github:maoshuhua/pavo-cli#v0.1.1",
  "git+https://github.com/maoshuhua/pavo-cli.git#v0.1.1",
  "https://github.com/maoshuhua/pavo-cli.git#v0.1.1",
]) {
  assert.strictEqual(isGitPackageSpec(pkg), true, `expected Git package spec: ${pkg}`);
}
assert.strictEqual(isGitPackageSpec(`${DEFAULT_PKG}@0.1.1`), false);

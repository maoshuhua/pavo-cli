...
assert.strictEqual(
  installPackage("github:maoshuhua/pavo-cli#v0.1.2"),
  "github:maoshuhua/pavo-cli#v0.1.2",
);
...
for (const pkg of [
  "github:maoshuhua/pavo-cli#v0.1.2",
  "git+https://github.com/maoshuhua/pavo-cli.git#v0.1.2",
  "https://github.com/maoshuhua/pavo-cli.git#v0.1.2",
]) {
  assert.strictEqual(isGitPackageSpec(pkg), true, `expected Git package spec: ${pkg}`);
}
assert.strictEqual(isGitPackageSpec(`${DEFAULT_PKG}@0.1.2`), false);
